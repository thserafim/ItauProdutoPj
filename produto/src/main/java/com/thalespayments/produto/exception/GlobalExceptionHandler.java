...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleChavePixNotFound(ChavePixNotFoundException ex) {
        ApiErrorResponse error = new ApiErrorResponse(HttpStatus.NOT_FOUND.value(), ex.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(error);
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
        ApiErrorResponse error = new ApiErrorResponse(HttpStatus.CONFLICT.value(), "Violacao de integridade de dados");
